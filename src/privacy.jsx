  ...
  return (
    <div className="terms-body">
      ...
      <div className="content">
        ...
        All transactional information including financial information gathered
        by the Company shall be stored on servers, log files and any other
        storage system owned by the Company or by third parties in India.
        <br />
        <br />
